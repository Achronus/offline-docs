...
description: "There are several middlewares available provided by Starlette directly."
---
...
### allow\_origins `instance-attribute`

```
allow_origins = allow_origins
```

### allow\_methods `instance-attribute`

```
allow_methods = allow_methods
```

### allow\_headers `instance-attribute`

```
allow_headers = [(lower()) for h in allow_headers]
```

### allow\_all\_origins `instance-attribute`

```
allow_all_origins = allow_all_origins
```

### allow\_all\_headers `instance-attribute`

```
allow_all_headers = allow_all_headers
```

### allow\_credentials `instance-attribute`

```
allow_credentials = allow_credentials
```

### preflight\_explicit\_allow\_origin `instance-attribute`
...
### allow\_origin\_regex `instance-attribute`

```
allow_origin_regex = compiled_allow_origin_regex
```

### allow\_private\_network `instance-attribute`

```
allow_private_network = allow_private_network
```

### simple\_headers `instance-attribute`

```
simple_headers = simple_headers
```

### preflight\_headers `instance-attribute`
...
### allow\_explicit\_origin `staticmethod`
...
### minimum\_size `instance-attribute`
...
### allowed\_hosts `instance-attribute`

```
allowed_hosts = list(allowed_hosts)
```

### allow\_any `instance-attribute`

```
allow_any = '*' in allowed_hosts
```

### www\_redirect `instance-attribute`
