...
description: "You can declare a parameter in a *path operation function* or dependency to be of type Response and then you can set data for the response like headers or cook…"
---
