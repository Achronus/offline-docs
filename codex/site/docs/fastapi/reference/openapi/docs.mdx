...
description: "Utilities to handle OpenAPI automatic UI documentation, including Swagger UI (by default at /docs) and ReDoc (by default at /redoc)."
---
...
## fastapi.openapi.docs.get\_swagger\_ui\_html
...
## fastapi.openapi.docs.get\_redoc\_html
...
## fastapi.openapi.docs.get\_swagger\_ui\_oauth2\_redirect\_html
...
## fastapi.openapi.docs.swagger\_ui\_default\_parameters `module-attribute`
