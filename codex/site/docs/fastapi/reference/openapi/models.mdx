...
description: "OpenAPI Pydantic models used to generate and validate the generated OpenAPI."
---
...
#### schema\_ `class-attribute` `instance-attribute`
...
#### not\_ `class-attribute` `instance-attribute`

```
not_ = Field(default=None, alias='not')
```

#### if\_ `class-attribute` `instance-attribute`
...
#### else\_ `class-attribute` `instance-attribute`
...
#### in\_ `class-attribute` `instance-attribute`
...
#### type\_ `class-attribute` `instance-attribute`
