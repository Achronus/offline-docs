...
description: "You can use the TestClient class to test FastAPI applications without creating an actual HTTP and socket connection, just communicating directly with the FastA…"
---
...
### follow\_redirects `instance-attribute`

```
follow_redirects = follow_redirects
```

### max\_redirects `instance-attribute`
...
### event\_hooks `property` `writable`
...
### async\_backend `instance-attribute`
