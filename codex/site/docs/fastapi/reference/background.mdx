...
description: "You can declare a parameter in a *path operation function* or dependency function with the type BackgroundTasks, and then you can use it to schedule the execut…"
---
