...
description: "When defining WebSockets, you normally declare a parameter of type WebSocket and with it you can read data from the client and send data to it."
---
...
### client\_state `instance-attribute`

```
client_state = CONNECTING
```

### application\_state `instance-attribute`
