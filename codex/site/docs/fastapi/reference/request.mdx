...
description: "You can declare a parameter in a *path operation function* or dependency to be of type Request and then you can access the raw request object directly, without…"
---
