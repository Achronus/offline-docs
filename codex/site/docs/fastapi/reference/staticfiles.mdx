...
description: "You can use the StaticFiles class to serve static files, like JavaScript, CSS, images, etc."
---
...
### all\_directories `instance-attribute`
...
### config\_checked `instance-attribute`

```
config_checked = False
```

### follow\_symlink `instance-attribute`
