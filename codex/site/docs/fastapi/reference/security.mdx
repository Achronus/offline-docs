...
description: "When you need to declare dependencies with OAuth2 scopes you use Security()."
---
...
### scheme\_name `instance-attribute`

```
scheme_name = scheme_name or __name__
```

### auto\_error `instance-attribute`

```
auto_error = auto_error
```

### make\_not\_authenticated\_error
...
### grant\_type `instance-attribute`
...
### client\_id `instance-attribute`

```
client_id = client_id
```

### client\_secret `instance-attribute`
