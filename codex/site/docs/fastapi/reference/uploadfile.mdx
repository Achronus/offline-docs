...
description: "You can define *path operation function* parameters to be of the type UploadFile to receive files from the request."
---
...
### content\_type `instance-attribute`
