...
sidebar_position: 98
description: "When deploying a **FastAPI** application, or actually, any type of web API, there are several concepts that you probably care about, and using them you can fin…"
---
...
![](/img/fastapi/img/deployment/concepts/image01.png)
...
![](/img/fastapi/img/deployment/concepts/process-ram.drawio.svg)
