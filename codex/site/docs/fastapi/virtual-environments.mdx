...
sidebar_position: 6
description: "When you work in Python projects you probably should use a **virtual environment** (or a similar mechanism) to isolate the packages you install for each projec…"
---
