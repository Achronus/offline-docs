...
sidebar_position: 3
description: "Python has support for optional \"type hints\" (also called \"type annotations\")."
---
...
![](/img/fastapi/img/python-types/image01.png)
...
![](/img/fastapi/img/python-types/image02.png)

With that, you can scroll, seeing the options, until you find the one that "rings a bell":

![](/img/fastapi/img/python-types/image03.png)
...
![](/img/fastapi/img/python-types/image04.png)
...
![](/img/fastapi/img/python-types/image05.png)
...
![](/img/fastapi/img/python-types/image06.png)
