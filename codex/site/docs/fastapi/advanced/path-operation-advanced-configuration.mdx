...
sidebar_position: 59
description: "If you are not an \"expert\" in OpenAPI, you probably don't need this."
---
...
![](/img/fastapi/img/tutorial/path-operation-advanced-configuration/image01.png)
