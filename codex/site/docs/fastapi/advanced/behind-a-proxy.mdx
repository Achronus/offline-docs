...
sidebar_position: 75
description: "In many situations, you would use a **proxy** like Traefik or Nginx in front of your FastAPI app."
---
...
![](/img/fastapi/img/tutorial/behind-a-proxy/image03.png)
