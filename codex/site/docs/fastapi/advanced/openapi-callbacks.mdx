...
sidebar_position: 84
description: "You could create an API with a *path operation* that could trigger a request to an *external API* created by someone else (probably the same developer that wou…"
---
...
![](/img/fastapi/img/tutorial/openapi-callbacks/image01.png)
