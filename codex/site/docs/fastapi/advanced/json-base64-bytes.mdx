...
sidebar_position: 89
description: "If your app needs to receive and send JSON data, but you need to include binary data in it, you can encode it as base64."
---
...
![](/img/fastapi/img/tutorial/json-base64-bytes/image01.png)
