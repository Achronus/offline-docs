...
sidebar_position: 74
description: "If you need to have two independent FastAPI applications, with their own independent OpenAPI and their own docs UIs, you can have a main app and \"mount\" one (o…"
---
...
![](/img/fastapi/img/tutorial/sub-applications/image01.png)
...
![](/img/fastapi/img/tutorial/sub-applications/image02.png)
