...
sidebar_position: 72
description: "FastAPI is built on top of **Pydantic**, and I have been showing you how to use Pydantic models to declare requests and responses."
---
...
![](/img/fastapi/img/tutorial/dataclasses/image01.png)
