...
sidebar_position: 12
description: "**FastAPI** allows you to declare additional information and validation for your parameters."
---
...
🤓 Other versions and variantsPython 3.10+ - non-Annotated
:::tip[Tip]
...
🤓 Other versions and variantsPython 3.10+
...
![](/img/fastapi/img/tutorial/query-params-str-validations/image02.png)
...
![](/img/fastapi/img/tutorial/query-params-str-validations/image01.png)
