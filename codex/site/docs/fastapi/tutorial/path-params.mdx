...
sidebar_position: 9
description: "You can declare path \"parameters\" or \"variables\" with the same syntax used by Python format strings:"
---
...
![](/img/fastapi/img/tutorial/path-params/image01.png)
...
![](/img/fastapi/img/tutorial/path-params/image02.png)
...
![](/img/fastapi/img/tutorial/path-params/image03.png)
