...
sidebar_position: 44
description: "Now let's build from the previous chapter and add the missing parts to have a complete security flow."
---
...
![](/img/fastapi/img/tutorial/security/image04.png)

After authenticating in the system, you will see it like:

![](/img/fastapi/img/tutorial/security/image05.png)
...
![](/img/fastapi/img/tutorial/security/image06.png)
