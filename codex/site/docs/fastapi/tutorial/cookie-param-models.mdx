...
sidebar_position: 22
description: "If you have a group of **cookies** that are related, you can create a **Pydantic model** to declare them. 🍪"
---
...
![](/img/fastapi/img/tutorial/cookie-param-models/image01.png)
:::note[Note]
