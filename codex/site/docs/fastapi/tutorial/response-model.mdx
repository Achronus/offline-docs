...
sidebar_position: 24
description: "You can declare the type used for the response by annotating the *path operation function* **return type**."
---
...
![](/img/fastapi/img/tutorial/response-model/image01.png)

And both models will be used for the interactive API documentation:

![](/img/fastapi/img/tutorial/response-model/image02.png)
