...
sidebar_position: 36
description: "Before diving deeper into the **Dependency Injection** system, let's upgrade the previous example."
---
...
![](/img/fastapi/img/tutorial/dependencies/image02.png)
