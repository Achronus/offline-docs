...
sidebar_position: 48
description: "**FastAPI** doesn't require you to use a SQL (relational) database. But you can use **any database** that you want."
---
...
![](/img/fastapi/img/tutorial/sql-databases/image01.png)
...
![](/img/fastapi/img/tutorial/sql-databases/image02.png)
