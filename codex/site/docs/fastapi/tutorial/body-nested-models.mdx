...
sidebar_position: 17
description: "With **FastAPI**, you can define, validate, document, and use arbitrarily deeply nested models (thanks to Pydantic)."
---
...
![](/img/fastapi/img/tutorial/body-nested-models/image01.png)
