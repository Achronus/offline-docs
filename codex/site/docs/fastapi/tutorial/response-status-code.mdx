...
sidebar_position: 26
description: "The same way you can specify a response model, you can also declare the HTTP status code used for the response with the parameter status_code in any of the *pa…"
---
...
![](/img/fastapi/img/tutorial/response-status-code/image01.png)
...
![](/img/fastapi/img/tutorial/response-status-code/image02.png)
