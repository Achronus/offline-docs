...
sidebar_position: 49
description: "If you are building an application or a web API, it's rarely the case that you can put everything in a single file."
---
...
![](/img/fastapi/img/tutorial/bigger-applications/package.drawio.svg)
...
Python 3.8+app/routers/users.py
...
Python 3.10+app/dependencies.py
...
Python 3.8+app/routers/items.py
...
Python 3.8+app/internal/admin.py
...
![](/img/fastapi/img/tutorial/bigger-applications/image01.png)
